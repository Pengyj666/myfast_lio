#ifndef COMMON_DEBUG_CLIENT_H
#define COMMON_DEBUG_CLIENT_H
...
class DebugClient {
 public:
  ...
  void SetUseAlign(bool use) { used_align_.store(use); }
  bool GetUseAlign() { return used_align_.load(); }
